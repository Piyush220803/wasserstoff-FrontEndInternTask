...
import { Cog, LogIn } from 'lucide-react'; // Removed Edit3, Library, Bot icons
        ...
        <Sidebar className="border-r" collapsible="icon">
          <SidebarHeader className="p-4 flex items-center gap-2 justify-between">
             <div className="flex items-center gap-2">
                ...
                <h1 className="text-xl font-semibold group-data-[collapsible=icon]:hidden">CollabText</h1>
             </div>
          </SidebarHeader>
          <SidebarContent>
            <AppSidebarNav />
          ...
          <main className="p-6">
            {user ? children : (
              <div className="flex flex-col items-center justify-center h-[calc(100vh-10rem)]">
                <p className="text-lg text-muted-foreground mb-4">Please enter your name to continue.</p>
